...
@section('content')
    <div class="row margin-bottom">
        <div class="col-md-6">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add new supplier</button>
        </div>
                        ...
                        @foreach($table as $row)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{route('supplier-del',['id' => $row->supplierID])}}" onclick="return confirm('Are you sure to delete?');" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
